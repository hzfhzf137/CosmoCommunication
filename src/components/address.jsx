...
const Address = () => {
  return (
    <div 
      className="bg-orange-400 text-gray-100 w-screen md:w-1/2 p-4 flex flex-col justify-center"
      style={{ minHeight: '50vh' }} // Ensure it takes up at least 50% of the viewport height
    >
      <h2 className="text-2xl font-bold mb-4 text-white">Cosmo Communication</h2>
