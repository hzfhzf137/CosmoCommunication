...
const Address = () => {
  return (
    <div className="bg-orange-400 text-gray-100 w-screen md:w-1/2 p-8 flex flex-col justify-center h-screen">
      <h2 className="text-3xl font-bold mb-6 text-white">Cosmo Communication</h2>
